...
const App: React.FC = () => {
  ...
  return (
    <div className='flex h-screen'>
      ...
      <main className="max-w-5xl mx-auto mt-14 bg-white min-h-screen">
        {createWorkspace &&
        ...
        {!isConfiguring ? (
          <section>
            ...
            <div className='flex justify-between mb-8'>
              ...
              <Button onClick={() => test()}>Criar workspace</Button>
            </div>
            ...
            {selectedWorkspace && (
              <>
                ...
                <section className='flex flex-col  gap-16 '>
                  ...
                  <form onSubmit={handleSubmit} className="mb-8  w-[50%]">
                    <h2 className="text-4xl font-semibold mb-8 text-zinc-800">Adicionar Número</h2>
